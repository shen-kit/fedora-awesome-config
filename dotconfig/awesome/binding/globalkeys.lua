...
function _M.get()
  ...
  -- awesome
    ...
    awful.key({ modkey }, "n", function() awful.spawn("flatpak run md.obsidian.Obsidian") end,
    ...
    awful.key({}, "Print", function()
        awful.util.spawn("scrot -z -s -e 'xclip -selection clipboard -t image/png -i $f && rm $f'")
      end,
      { description = "screenshot selection to clipboard", group = "utilities" }),
    awful.key({ "Shift" }, "Print", function()
        awful.util.spawn("scrot -z -s ~screenshot.png")
      end,
